...
fluctuating_info <- function(plotdata1, plotdata2, rawdata1=NULL, rawdata2=NULL, rTruePop = .95, rObserved = NULL,
...
# get the object name of plotdata2, to be used in the returned output
titre <- deparse(substitute(plotdata2))
...
IRToutput <- list(rObserved=rObserved, rTruePop=rTruePop, propred1=propred1, propred2=propred2,
                  correctedR1=correctedR1, correctedR2=correctedR2, titre=titre)
